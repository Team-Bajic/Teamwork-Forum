...
Forum.views = (function() {
  var MainView = function(categories, questions, userData){
    ...
    this.categoriesHtml = Forum.templates.CategoriesTemplate.template({categories: categories});
    this.questionsHtml = Forum.templates.QuestionsTemplate.template({questions: questions});
  }
